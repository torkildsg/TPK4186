...
class Printer:
    ...
    def printHTML(self, terminationDates, bestTermination):
        ...
        <p>Test(in 'Tester.py'): To test task 2 and run the simulationLoop and print the execution of five batches, run codeline 56-72 in Tester.py. The result will show in the terminal.</p>
        """
        ...
        <p>Test(in 'Tester.py'): To test the optimizer class, run codeline 77-85 in Tester.py. The result will store a file called 'optimized.html' file that you need to open in your internet-browser. The result should contain a histogram and two tables.</p>
        """
